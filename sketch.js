...
function draw() {
  ...
  //when the mario is touching the coin ,producing the sound,destroying the coin, increasing the score
...
//if the obstacle is touching the mario life will decreasing and game state change to END
